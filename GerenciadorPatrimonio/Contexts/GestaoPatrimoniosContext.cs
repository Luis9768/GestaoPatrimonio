...
namespace GerenciadorPatrimonio.Contexts;
...
public partial class GestaoPatrimoniosContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AreaID).HasName("PK__Area__70B820288E3BED0D");

            entity.HasIndex(e => e.NomeArea, "UQ__Area__9A779760768F90AE").IsUnique();
        ...
        {
            entity.HasKey(e => e.BairroID).HasName("PK__Bairro__4A093623DD7F51FA");
        ...
        {
            entity.HasKey(e => e.CargoID).HasName("PK__Cargo__B4E665EDB4B7AFA5");

            entity.HasIndex(e => e.NomeCargo, "UQ__Cargo__4D9FD7DE0E8B193E").IsUnique();
        ...
        {
            entity.HasKey(e => e.CidadeID).HasName("PK__Cidade__B6800959BC69FA6A");
        ...
        {
            entity.HasKey(e => e.EnderecoID).HasName("PK__Endereco__B9D9462FC1A0DF73");
        ...
        {
            entity.HasKey(e => e.LocalizacaoID).HasName("PK__Localiza__83ABDECA923E67C7");
        ...
        {
            entity.HasKey(e => e.LogPatrimonioID).HasName("PK__LogPatri__E716D12B7E726FE2");
        ...
        {
            entity.HasKey(e => e.PatrimonioID).HasName("PK__Patrimon__C5A60BDED5B8D5CF");

            entity.ToTable(tb => tb.HasTrigger("trg_Patrimonio_SoftDelete"));

            entity.HasIndex(e => e.NumeroPatrimonio, "UQ__Patrimon__3BC8B35D13AB5BB1").IsUnique();
        ...
        {
            entity.HasKey(e => e.TransferenciaID).HasName("PK__Solicita__E5B4F5F21FB1EE93");
        ...
        {
            entity.HasKey(e => e.StatusPatrimonioID).HasName("PK__StatusPa__B3F336091CD66BA9");

            entity.HasIndex(e => e.NomeStatus, "UQ__StatusPa__C5C60F1A0E460350").IsUnique();
        ...
        {
            entity.HasKey(e => e.StatusTransferenciaID).HasName("PK__StatusTr__7AA828B9995C5DA3");

            entity.HasIndex(e => e.NomeStatus, "UQ__StatusTr__C5C60F1AF0EF367F").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoAlteracaoID).HasName("PK__TipoAlte__9BEF4F0D0E01FAAF");

            entity.HasIndex(e => e.NomeTipo, "UQ__TipoAlte__7859A10A77A38880").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoPatrimonioID).HasName("PK__TipoPatr__4DC9FF998E130BBE");

            entity.HasIndex(e => e.NomeTipo, "UQ__TipoPatr__7859A10AA6222DAC").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoUsuarioID).HasName("PK__TipoUsua__7F22C702B4DD711D");

            entity.HasIndex(e => e.NomeTipo, "UQ__TipoUsua__7859A10A6E180196").IsUnique();
        ...
        {
            entity.HasKey(e => e.UsuarioID).HasName("PK__Usuario__2B3DE798EB202BF4");

            entity.ToTable(tb => tb.HasTrigger("trg_Usuario_SoftDelete"));

            entity.HasIndex(e => e.RG, "UQ__Usuario__321537C8EB384B3C").IsUnique();

            entity.HasIndex(e => e.CarteiraTrabalho, "UQ__Usuario__6E25BCA2E0B3C46E").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Usuario__A9D1053463B940FC").IsUnique();

            entity.HasIndex(e => e.CPF, "UQ__Usuario__C1F8973153DA4A95").IsUnique();

            entity.HasIndex(e => e.NIF, "UQ__Usuario__C7DEC3307CAA1F8B").IsUnique();
